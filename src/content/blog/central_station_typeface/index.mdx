...
[Skip to the end](#the-font-in-all-its-glory) to see the final font.
...
Finally, I add in some modern sensibilities to the font, taking queues from the great accessible font, [Atkinson Hyperlegible](https://brailleinstitute.org/freefont). The i's and the l's are made to be distinct from each other.
...
import FontTester from "../../../components/FontTester.astro";

<FontTester client:load />
