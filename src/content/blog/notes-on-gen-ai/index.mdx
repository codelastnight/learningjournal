...
[This article from the bbc](https://www.bbc.com/worklife/article/20230127-how-worker-surveillance-is-backfiring-on-employers) argues that these automated surveillence tools does more harm then good, citing increased stress and lack of agency leads to more rule breaking and bad behavior.

[on the other side of the coin](https://www.raconteur.net/technology/employee-surveillance-ai), well. uh.
...
as discussed in Ruben Peter's _CAPS LOCK_ designers historically have played a role
...
i was watching this funny video to learn about yolo which is the leading object detection model.

import { YouTube } from "@astro-community/astro-embed-youtube";

<YouTube id='https://www.youtube.com/watch?v=C4i8Bia83TM' />

I also read up on [Deep Sparse](https://neuralmagic.com/blog/yolov8-detection-10x-faster-with-deepsparse-500-fps-on-a-cpu/), as I thought that if i were to run this program, I would have to use the smaller models + deep sparse to get any sort of speed out of my laptop.
